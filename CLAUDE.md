...
This project is indexed by GitNexus as **FamLink** (3082 symbols, 4255 relationships, 89 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
