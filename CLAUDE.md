...
This project is indexed by GitNexus as **FamLink** (2504 symbols, 4028 relationships, 106 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
